As the description said this is a basic version of Pong build on Java featuring a single player mode aswell as the option to play together on the same device. 
